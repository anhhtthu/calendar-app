...
@endif */}
      ...
      <ul className="flex border-b border-gray-300 text-sm font-medium text-gray-600 mt-3 px-6 md:px-0">
        ...
        <Link to="/change-password" className="py-4 inline-block">Change Password</Link>
        </li>
      </ul>
      <form action="{{ route('profile.save') }}" method="POST" encType="multipart/form-data" onSubmit={handleFormSubmit}>
        ...
        <div className="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
          ...
          <div className="md:w-2/3 w-full">
            ...
            <div className="py-8 px-16">
              ...
              <input
                className="mt-2 border-2 border-gray-200 bg-gray-100 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-"
                type="email"
                name="email"
        ...
        <div className="flex justify-between items-center  p-16 py-8 bg-gray-100 rounded-b-lg border-t border-gray-300">
          <div className="text-xs text-gray-500 tracking-tight">
            <p>Click to update your Profile Info</p>
          </div>
